...
\begin{itemize}
  ...
  [this post](https://support.bioconductor.org/p/70196/#70509)
...
\begin{description}
  ...
  - {\Rcode{bpworkers}; \Rcode{bpnworkers}: }
...
\subsection{*Ad hoc* cluster of multiple machines}
